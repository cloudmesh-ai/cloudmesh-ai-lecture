...
13. Have you not used phrases such as shown in the Figure below, but
    instead used as shown in Figure \ref when referring to
...
!!! assignment "Report 2"
    Check out the report example directory. Use `make` and view the PDF. Modify and recompile.
...
!!! assignment "Report 8"
    Why are spaces and underscores in directory names problematic, and why should you avoid using them for your projects?

!!! assignment "Report 9"
    Write an objective report about the advantages and disadvantages of programs to write reports.

!!! assignment "Report 10"
    Why is it advantageous that directories are lowercase and have no underscore or space in the name?

!!! assignment "Report 11"
    Review in a grammar book the proper usage of "a" and "the".

!!! assignment "Report 12"
    Memorize: When writing quotes use \`\`quote'' and not "quote". Note these are two quotes left to the one to open and two other quotes right to the enter (US keyboard) to close a quote.

...
!!! note "Assignment W2.1. VM on local machine."
    ...
    You will upload this to GitHub. You will be provided with a Repo. Week 1. Assignment 3. must bee completed before you can do the submission.
...
!!! note "Assignmnet W1.3. Create class accounts"
    ...
    d. Make ssure your piazza account works by posting the account information to Piazza.


    Completion of the Account assignments

    Send a messga to the account folder in "Piazza" with the following information. Please use the name registered with LUC. Please use the follwoing format 

    When submitting this post make sure to select lecture/accounts. Make suer you use as subject 

    ```
    Firsname Lastname (email@luc.edu)
    ```

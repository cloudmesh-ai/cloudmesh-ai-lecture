...
## 1️⃣ What size of LLM fits on a RTX 3090?
...
## 2️⃣ Serving stacks – speed vs. convenience
...
## 3️⃣ Concrete model recommendations for a 24 GB RTX 3090
...
## 4️⃣ Step‑by‑step: Install & run each stack
...
## 5️⃣ Benchmarking – how to measure throughput & latency
...
## 6️⃣ Putting it all together – recommended workflow

---
title: "Python Modules {#sec:python-modules}"
---

!!! info "Learning Outcomes"
    - Install and manage third-party Python libraries using `pip` and the Python Package Index (PyPI).
    - Use virtual environments (`venv`) to isolate project dependencies and avoid system-wide conflicts.
    - Implement basic GUI applications using libraries such as GUIZero or Kivy.
    - Improve code quality and maintainability by applying automatic formatting tools like `autopep8`.
...
Often you can find a previous implementation of what you need. Since this is a common situation, there is a service supporting it: the [Python Package Index](https://pypi.python.org/pypi) (or PyPi for short).
...
The Python Package Index is a large repository of software for the Python programming language containing a large number of packages, many of which can be found on [pypi](https://pypi.python.org/pypi). The nice thing about pypi is that many packages can be installed with the program 'pip'.
...
If you are unfamiliar with programming in Python, we also refer you to some of the numerous online resources. You may wish to start with [Learn Python](https://www.learnpython.org) or the book [Learn Python the Hard Way](http://learnpythonthehardway.org/book/). Other options include [Tutorials Point](http://www.tutorialspoint.com/python/) or [Code Academy](http://www.codecademy.com/en/tracks/python), and the Python wiki page contains a long list of [references for learning](https://wiki.python.org/moin/BeginnersGuide/Programmers) as well. Additional resources include:

...
!!! info "Learning Outcomes"
    - Use the `click` library to create composable command-line interfaces.
    - Implement command-line options and arguments with automatic help page generation.
    - Create interactive shells for click commands using the `click-shell` extension.

Click allows developers to create composable command line interfaces. It aims to simplify the process of writing command line tools. Highlights include:
